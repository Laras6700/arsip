        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <?php if ($user == 'admin ketua' || $user == 'admin') { ?>
                    <div class="row">
                        <!-- total surat masuk -->
                        <div class="<?php if ($user == 'admin ketua') {
                                        echo 'col-xl-3';
                                    } else {
                                        echo 'col-xl-6';
                                    } ?> col-md-6 mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php foreach ($count_jadwal as $key) {
                                                        echo $key->total;
                                                    }  ?>
                                                </div>
                                            </div>
                ...
                <?php if ($user == 'member' || $user == 'masyarakat') { ?>
                    <div class="row">
                        <!-- total surat masuk -->
                        <div class="<?php if ($user == 'admin ketua') {
                                        echo 'col-xl-3';
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php foreach ($count_galeri as $key) {
                                                    echo $key->total;
                                                }  ?>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div class="dropdown no-arrow">
                                        <a href="<?= base_url('admin/jadwal') ?>" class="text-dark" style="text-decoration: none">Lihat semua</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div class="dropdown no-arrow">
                                        <a href="<?= base_url('admin/dokumentasi') ?>" class="text-dark" style="text-decoration: none">Lihat semua</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
