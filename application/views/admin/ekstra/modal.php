				...
				<div class="card-body row">
					...
					<div class="col-md">
						...
						<div class="form-group">
							...
							<?php $indeks = $this->db->get('indeks')->result(); ?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form role="form" action="<?= base_url('admin/tambahsk') ?>" method="post" enctype="multipart/form-data">
					<input type="hidden" name="id_suratmasuk" class="id_suratmasuk">
					<div class="card-body row">
						<div class="col-md">
							<div class="form-group">
								<label>No. Surat</label>
...
<div class="modal fade" id="balas_surat">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Tambah Data</h4>
				...
				<form role="form" action="<?= base_url('admin/tambahuser') ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select class="form-control" name="level" id="">
							...
							<option value="1">Admin Ketua</option>
